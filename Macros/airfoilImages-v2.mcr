...
$!VarSet |ALPHA|    = '1.234'  # Angle-of-Attack
$!VarSet |CL|       = '0.123'  # Lift Coefficient
$!VarSet |CD|       = '0.0456' # Drag Coefficient
$!VarSet |CMy|      = '-0.789' # Pitching Moment Coefficient
...
$!VarSet |CFvar|  =  5      # Variable number to use for Cf contours
$!VarSet |CFXvar| =  6      # Variable number to use for Cfx contours
$!VarSet |CFYvar| =  7      # Variable number to use for Cfx contours
$!VarSet |CFZvar| =  8      # Variable number to use for Cfx contours
$!VarSet |Uvar|   =  9      # Variable number to use for x-component of velocity vector in streamtraces
$!VarSet |Vvar|   =  10     # Variable number to use for y-component of velocity vector in streamtraces
$!VarSet |Wvar|   =  11     # Variable number to use for z-component of velocity vector in streamtraces
...
$!ThreeDAxis
  ...
  DepXToZRatio = 1
  EdgeAutoReset = Yes
  FrameAxis { Size = 15 XYPos { X = 2 Y = 28 } Show = No}
