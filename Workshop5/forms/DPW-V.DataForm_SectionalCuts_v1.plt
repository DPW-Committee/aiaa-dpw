#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
#   DPW-V SECTIONAL CUT DATA SUBMITTAL FORM (Version 1 - 11 MAY 2012)
#
#       Due 21 MAY 2012
#
...
TITLE = "XXX"
VARIABLES =   "X"       "Y"       "Z"      "CP"      "CF"       "CFX"     "CFY"     "CFZ"
...
DATASETAUXDATA GridLevel       = "1, 2, 3, 4, 5, 6"
DATASETAUXDATA GridSize        = "????????."
DATASETAUXDATA Mach            = "0.85"
DATASETAUXDATA Alpha           = "?.???"
DATASETAUXDATA CL_TOT          = "0.????"
DATASETAUXDATA Case            = "1 or 2"
...
#-------------------------------------------------------------------------------
ZONE T="XXX - WING SECTION  1"
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            etc.

ZONE T="XXX - WING SECTION  2"
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            etc.

ZONE T="XXX - WING SECTION  3"
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            etc.

ZONE T="XXX - WING SECTION  4"
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            etc.

ZONE T="XXX - WING SECTION  5"
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            etc.

ZONE T="XXX - WING SECTION  6"
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            etc.

ZONE T="XXX - WING SECTION  7"
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            etc.

ZONE T="XXX - WING SECTION  8"
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            etc.

ZONE T="XXX - WING SECTION  9"
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            etc.

ZONE T="XXX - WING SECTION 10"
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            etc.

ZONE T="XXX - WING SECTION 11"
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            etc.

ZONE T="XXX - WING SECTION 12"
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            etc.

ZONE T="XXX - WING SECTION 13"
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            etc.

ZONE T="XXX - WING SECTION 14"
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            etc.

ZONE T="XXX - WING SECTION 15"
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            etc.

ZONE T="XXX - WING SECTION 16"
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            ???.????  ???.????  ???.????  ?.??????  ?.???????  ?.??????  ?.??????  ?.??????
            etc.
